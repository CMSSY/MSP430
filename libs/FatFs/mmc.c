...
#define DLY_US(n)       __delay_cycles(n)   //Delay n microseconds assuming MCLK=1MHz
...
DRESULT disk_ioctl (
    ...
    uint32_t *buff /* Buffer to send/receive control data */               //KLQ  Changed from void* to uint32_t*
    )
{
    DRESULT res;
    uint8_t n, csd[16];
